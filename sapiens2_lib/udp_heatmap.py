...
# Vendored layout note: upstream had a `utils/` subpackage; we
# renamed it to `codec_utils/` to avoid clashing with the very
# generic name in the parent ComfyUI-4DHumans namespace.
