...
# Upstream uses loguru; vendored here we swap for stdlib logging to avoid
# an extra runtime dependency ComfyUI doesn't ship. The `.debug/.info/
# .warning` methods are API-compatible.
import logging
logger = logging.getLogger("crowdsam")
import math
